...
const app=$('#app');
app.innerHTML=`<header><div class="brand-stack"><a class="brand" href="./"><span class="brand-icon">C<span>✦</span></span><span>Ceo<span class="brand-light">-body</span><small>HUMAN ANATOMY STUDIO</small></span></a><div class="developer-credit" aria-label="ผู้พัฒนา"><strong>พัฒนาโดย ผอ.สุธน พุทธรัตน์</strong><span>ผู้อำนวยการโรงเรียนวัดไผ่มุ้ง</span></div></div><div class="header-note" id="headerNote"></div><div class="header-actions"><button id="resultsButton"></button><button id="quality"></button><div class="language"><button id="th">ไทย</button><button id="en">EN</button></div></div></header>
