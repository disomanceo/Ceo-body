...
- Header v1.6.1: เพิ่มตราโรงเรียนวัดไผ่มุ้งและชื่อ “สื่อการสอนกายวิภาคแบบโต้ตอบ ของโรงเรียนวัดไผ่มุ้ง” ตรงกลางแบบ compact; เครดิตผู้พัฒนามุมซ้ายใช้โทน teal เข้ากับธีม และลดความสูง header เหลือ 58px desktop / 52px mobile เพื่อรักษาพื้นที่โมเดลหลัก
